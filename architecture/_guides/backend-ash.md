...
- [quick-reference.md](../_fundamentals/quick-reference.md) - Core patterns
- [frontend-svelte.md](./frontend-svelte.md) - Svelte integration
- [real-time.md](./real-time.md) - PubSub and notifications
