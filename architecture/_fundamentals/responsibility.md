...
> See [quick-reference.md](./quick-reference.md#anti-patterns) for rationale
...
- [quick-reference.md](./quick-reference.md) - Core decisions
- [backend-ash.md](../_guides/backend-ash.md) - Ash patterns
- [frontend-svelte.md](../_guides/frontend-svelte.md) - Svelte patterns
